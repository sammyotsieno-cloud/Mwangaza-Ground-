...
class AppContainer(context: Context) {
    ...
    val receivingService: GoodsReceiptPersistenceService = GoodsReceiptPersistenceService(database)
    val consumptionService: ConsumptionService = ConsumptionService(database)
}
